...
// Network credentials
#define WIFI_SSID "LCS_MAIN"
#define WIFI_PASSWORD "lcs032020"

// Firebase project API key
#define API_KEY "AIzaSyAzK7Q-GYe9fZVbcfSnXwjgDK4bCmp_BtA"

// Authorized username dan password
#define USER_EMAIL "nerray7@gmail.com"
#define USER_PASSWORD "rainierganteng"

// RTDB URL
#define DATABASE_URL "https://esp-firebase-demo-fe24e-default-rtdb.asia-southeast1.firebasedatabase.app/"
...
// Callback funtion that runs on database changes
...
void setup() {
  ...
  // Initialize outputs Relay
  pinMode(output1, OUTPUT);

  // Initalize output Switch
  pinMode(output2, INPUT_PULLUP);

  // During starting all relays should TURN OFF
  digitalWrite(output1, toggleState);

  config1.setEventHandler(button1Handler);

  button1.init(output2);
  ...
  // Intialize the library with the Firebase authen and config
  ...
  //Assign a callback funtion to run when it detect changes on the database
